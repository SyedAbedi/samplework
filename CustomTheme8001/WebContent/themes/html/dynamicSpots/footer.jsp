...
<div class="wpthemeFooterCol wpthemeLeft">
	...
	<ul>
		<li><a href="<portal-navigation:urlGeneration contentNode='ibm.portal.Search'><% wpsURL.write(escapeXmlWriter); %></portal-navigation:urlGeneration>"><portal-fmt:text key="search.center.page" bundle="nls.commonUI"/></a></li>
		<li><a href="<portal-navigation:urlGeneration contentNode='ibm.portal.Tagging'><% wpsURL.write(escapeXmlWriter); %></portal-navigation:urlGeneration>"><portal-fmt:text key="tagging.rating.page" bundle="nls.commonUI"/></a></li>
	</ul>
</div>
</portal-logic:if>